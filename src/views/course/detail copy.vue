    ...
    <div class="container">
      <div class="left">
        <el-card class="box-card" shadow="never">
          ...
          <el-table ref="table" class="chapter_table" highlight-current-row size="small" :show-header="false" v-loading="dataListLoading"
            :data="dataList" row-key="courseChapterId" lazy :load="treeLazyLoad" @row-click="rowClick">
